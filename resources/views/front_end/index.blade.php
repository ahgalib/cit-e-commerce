                    ...
                    <div class="intro-slider owl-carousel owl-simple owl-dark owl-nav-inside" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{asset('front_end_asset/images/demos/demo-3/slider/slide-1-480w.jpg')}}">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/slider/slide-1.jpg')}}" alt="Image Desc">
                                </picture>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{asset('front_end_asset/images/demos/demo-3/slider/slide-2-480w.jpg')}}">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/slider/slide-2.jpg')}}" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
            ...
            <div class="col-lg-4">
                <div class="intro-banners">
                    <div class="banner mb-lg-1 mb-xl-2">
                        <a href="#">
                            <img src="{{asset('front_end_asset/images/demos/demo-3/banners/banner-1.jpg')}}" alt="Banner">
                        </a>
                    ...
                    <div class="banner mb-lg-1 mb-xl-2">
                        <a href="#">
                            <img src="{{asset('front_end_asset/images/demos/demo-3/banners/banner-2.jpg')}}" alt="Banner">
                        </a>
                    ...
                    <div class="banner mb-0">
                        <a href="#">
                            <img src="{{asset('front_end_asset/images/demos/demo-3/banners/banner-3.jpg')}}" alt="Banner">
                        </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="{{route('product.details',$product->slug)}}">
                                <img src="{{asset('upload/products')}}/{{$product->preview}}" alt="Product image" class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            <div class="product-cat">
                                <a href="{{route('product.details',$product->slug)}}">Cameras & Camcorders</a>
                            </div><!-- End .product-cat -->
                            ...
                            <div class="product-price">
                                ...
                                <div style="width:40px;height:1px;background:black;margin-left:-40px;"></div>

                                <div style="margin-left:20px;">
                                    <span style="color:red;">  {{ $product->after_discount}} tk.</span>
                                </div>
                                @endif
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url({{asset('front_end_asset/images/demos/demo-3/deal/bg-1.jpg')}}">
                    <div class="deal-top">
                        ...
                        <div class="col-6">
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-5.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-6.jpg')}}" alt="Product image" class="product-image">
                                    </a>
...
<div class="container">
    <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl"
            ...
            <a href="#" class="brand">
                <img src="{{asset('front_end_asset/images/brands/1.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('front_end_asset/images/brands/2.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('front_end_asset/images/brands/3.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('front_end_asset/images/brands/4.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('front_end_asset/images/brands/5.png')}}" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="{{asset('front_end_asset/images/brands/6.png')}}" alt="Brand Name">
            </a>
        </div><!-- End .owl-carousel -->
</div><!-- End .container -->
...
<div class="container trending">
    <div class="heading-left">
        <h2 class="title">Tranding Products</h2><!-- End .title -->
    </div>
    ...
    <div class="row">
        <div class="col-xl-5col d-none d-xl-block">
            <div class="banner">
                <a href="#">
                    <img src="{{asset('front_end_asset/images/demos/demo-3/banners/banner-4.jpg')}}" alt="banner">
                </a>
            </div><!-- End .banner -->
        </div><!-- End .col-xl-5col -->
                    ...
                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.html">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-7.jpg')}}" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-8.jpg')}}" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-9.jpg')}}" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                ...
                                <span class="product-label label-circle label-sale">Sale</span>
                                <a href="product.html">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-10.jpg')}}" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.html">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-15.jpg')}}" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.html">
                                    <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-11.jpg')}}" alt="Product image" class="product-image">
                                </a>
        ...
        <div class="tab-pane p-0 fade show active" id="top-all-tab" role="tabpanel" aria-labelledby="top-all-link">
            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product product-2">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-12.jpg')}}" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product product-2">
                    <figure class="product-media">
                        <span class="product-label label-circle label-new">New</span>
                        <a href="product.html">
                            <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-13.jpg')}}" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product product-2">
                    <figure class="product-media">
                        ...
                        <span class="product-label label-circle label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{asset('front_end_asset/images/demos/demo-3/products/product-14.jpg')}}" alt="Product image" class="product-image">
                        </a>
...
<div class="container">
    <div class="cta cta-separator cta-border-image cta-half mb-0" style="background-image: url({{asset('front_end_asset/images/demos/demo-3/bg-2.jpg')}});">

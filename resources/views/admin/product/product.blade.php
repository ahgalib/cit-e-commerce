                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{route('product.add.inventory',$products->id)}}">Inventory</a>
                                        <a class="dropdown-item" href="{{route('product.edit',$products->slug)}}">Edit</a>

                                        <a class="dropdown-item" href="{{route('product.delete',$products->id)}}">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
